...
#from movie_recommendation import recommended_plot,get_recommeded_movies
from user_genre_analysis import plot_user_genre_preferences,get_horizontal_bar_chart
...
app.layout = html.Div(style={'backgroundColor': '#f0f0f0'},children=[
    html.H1('CineScope: Exploring MovieLens Data Through Visual Analytics', style={'textAlign': 'center', 'color': '#ffffff', 'fontFamily': 'Arial, sans-serif', 'marginBottom': '20px', 'fontSize': '36px', 'fontWeight': 'bold', 'backgroundColor': '#007bff', 'padding': '20px'}),
    dcc.Tabs(id='tabs', value='tab1', children=[
        ...
        dcc.Tab(label='MOVIE TAG WORDCLOUD', value='tab2', style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
        ...
        dcc.Tab(label='GENRE-LINE-PLOT', value='tab3',style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
            selected_style={'backgroundColor': '#f0f0f0'}, children=[
        ...
        dcc.Tab(label='MOVIE-GENRE-DISTRIBUTION', value='tab4',style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
            selected_style={'backgroundColor': '#f0f0f0'}, children=[
        ...
        dcc.Tab(label='GENRE VS GENRE', value='tab5',style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
            selected_style={'backgroundColor': '#f0f0f0'}, children=[
            html.H2(children=''),
        ...
        ####### Implemented by Abhishek
        dcc.Tab(label='TEMPORAL ANALYSIS', value='tab6', style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
            selected_style={'backgroundColor': '#f0f0f0'},children=[
                html.Div([
                    html.Div([
        ...
        #dcc.Tab(label='MOVIE RECOMMENDATION', value='tab7',style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
        #    selected_style={'backgroundColor': '#f0f0f0'}, children=[
        #    html.Div([
        #       dcc.Dropdown(
        ...
        #]),
        dcc.Tab(label='USER GENRE ANALYSIS', value='tab8',style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
            selected_style={'backgroundColor': '#f0f0f0'}, children=[
            html.H1("Genre Distribution for each user"),
            html.Label("Select User ID:"),
            dcc.Dropdown(
                id='user-dropdown_tab8',
                options=[{'label': str(uid), 'value': uid} for uid in range(1, 138494)],
                value=1
            ),
            dcc.Graph(id='sunburst-chart2')
        ]),
        dcc.Tab(label='MOVIE GENRE ANALYSIS', value='tab9',style={'font-weight': 'bold', 'backgroundColor': '#ffffff', 'marginBottom': '10px', 'width': '200px', 'textAlign': 'center'},
            selected_style={'backgroundColor': '#f0f0f0'}, children=[
            html.H1("Recommended Movies Genre Analysis"),
            html.Label("Select Recently Watch Movie:"),
            dcc.Dropdown(
                id='user-dropdown_tab9',
                options=movie_options,
                value=movie_options[0]['value']
            ),
            dcc.Graph(id='horizontal_bar_chart')
        ]),
        # Add other tabs here...
...
@app.callback(
    ...
    [Input('user-dropdown_tab8', 'value')]
)
def get_user_genre_plot(user_id):
    return plot_user_genre_preferences(user_id)


@app.callback(
    Output('horizontal_bar_chart','figure'),
    [Input('user-dropdown_tab9','value')]
)
def get_horizontal_plot(movie_name):
    movies_list = get_recommeded_movies(movie_name)
    return get_horizontal_bar_chart(movies_list)
####################
